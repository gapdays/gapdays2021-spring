This is the website for the [GAP days](https://www.gapdays.de/gapdays2021-spring).
...
```
  git clone https://github.com/gapdays/gapdays2021-spring
  cd gapdays2021-spring
  jekyll serve -w
```
